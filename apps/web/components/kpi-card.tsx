  ...
  return (
    <article className="og-card min-h-[118px]">
      <div className="flex items-start justify-between gap-3">
        <div>
          <p className="text-xs font-semibold uppercase tracking-normal text-og-gray">{kpi.label}</p>
          <p className="mt-2 font-poppins text-[28px] font-semibold leading-none text-og-dark">{kpi.value}</p>
        </div>
